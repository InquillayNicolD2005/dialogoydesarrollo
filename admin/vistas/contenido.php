...
<div class="shell">
  ...
  <div class="content"><header class="topbar"><div><h1><?= e($definition['label']) ?></h1><p>Completa los datos y guarda los cambios de esta sección.</p></div><div class="topbar-actions"><span class="welcome">Hola, <?= e(adminName()) ?></span><a class="public-link" href="change-password.php">Cambiar contraseña</a><a class="logout-link" href="logout.php">Cerrar sesión</a></div></header>
    <main class="main">
