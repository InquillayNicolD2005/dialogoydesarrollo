...
{
    return [
        'noticias' => ['label' => 'Actualidad', 'table' => 'noticias', 'id' => 'id', 'title' => 'titulo', 'description' => 'descripcion', 'date' => 'fecha_publicacion', 'status' => 'estado', 'image' => 'foto', 'link' => 'link_externo', 'db' => ['id' => 'id', 'titulo' => 'titulo', 'descripcion' => 'descripcion', 'fecha_publicacion' => 'fecha_publicacion', 'estado' => 'estado', 'foto' => 'foto', 'link_externo' => 'link_externo']],
        'reportajes' => ['label' => 'Reportajes', 'table' => 'reportajes', 'id' => 'id', 'title' => 'titulo', 'date' => 'fecha_publicacion', 'status' => 'estado', 'summary' => 'resumen_corto', 'description' => 'desarrollo', 'image' => 'foto_principal', 'pdf' => 'pdf_adjunto', 'featured' => 'es_destacado', 'author' => 'autor_id', 'db' => ['id' => 'id', 'titulo' => 'titulo', 'fecha_publicacion' => 'fecha_publicacion', 'estado' => 'estado', 'resumen_corto' => 'resumen_corto', 'desarrollo' => 'desarrollo', 'foto_principal' => 'foto_principal', 'pdf_adjunto' => 'pdf_adjunto', 'es_destacado' => 'es_destacado', 'autor_id' => 'autor_id']],
        'boletines' => ['label' => 'Boletines', 'table' => 'boletines', 'id' => 'id', 'number' => 'numero_boletin', 'summary' => 'resumen', 'date' => 'fecha_publicacion', 'status' => 'estado', 'image' => 'foto_portada', 'pdf' => 'archivo_pdf', 'db' => ['id' => 'id', 'numero_boletin' => 'numero_boletin', 'resumen' => 'resumen', 'fecha_publicacion' => 'fecha_publicacion', 'estado' => 'estado', 'foto_portada' => 'foto_portada', 'archivo_pdf' => 'archivo_pdf']],
        'podcasts' => ['label' => 'Podcasts', 'table' => 'podcasts', 'id' => 'id', 'title' => 'titulo', 'description' => 'descripcion', 'date' => 'fecha_publicacion', 'status' => 'estado', 'embed' => 'url_embed', 'db' => ['id' => 'id', 'titulo' => 'titulo', 'descripcion' => 'descripcion', 'fecha_publicacion' => 'fecha_publicacion', 'estado' => 'estado', 'url_embed' => 'url_embed']],
        'videos' => ['label' => 'Videos', 'table' => 'videos', 'id' => 'id', 'title' => 'titulo', 'description' => 'descripcion', 'date' => 'fecha_publicacion', 'status' => 'estado', 'image' => 'imagen', 'embed' => 'url_embed', 'db' => ['id' => 'id', 'titulo' => 'titulo', 'descripcion' => 'descripcion', 'fecha_publicacion' => 'fecha_publicacion', 'estado' => 'estado', 'imagen' => 'imagen', 'url_embed' => 'url_embed']],
    ];
}
